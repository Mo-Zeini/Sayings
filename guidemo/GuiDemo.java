...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		content.add(makeToolbar(), BorderLayout.NORTH); // // Adding a toolbar to the NORTH of the layout
	...
	/**
	 * Make a JToolBar that duplicates the functionality of the "Background" menu
	 * except for the JCheckBox that is at the bottom of the menu.
	 * @return toolbar
	 */
	private JToolBar makeToolbar() {
		JToolBar toolbar = new JToolBar("Background");
		JButton newPictureAct = toolbar.add(newPictureAction);
		newPictureAct.setToolTipText("Reset to default");
		JButton saveImage = toolbar.add(saveImageAction);
		saveImage.setToolTipText("Save Image");
